...
export default async function handler(request, response) {
  ...
  try {
    ...
    const currentSourceText = compactMaterialSources(body.materialPacket?.files || [], resolveSourceCharLimit('KOMITE_MAX_SOURCE_CHARS', 16000, 'KOMITE', TASK_NAME), { task: TASK_NAME });
