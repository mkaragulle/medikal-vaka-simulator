  ...
  properties: {
    lesson: {
      ...
      properties: {
        ...
        highYieldPoints: { type: 'array', minItems: 8, maxItems: 12, items: { type: 'string' } },
        mustKnow: { type: 'array', minItems: 4, maxItems: 10, items: { type: 'string' } },
        finalReview: { type: 'array', minItems: 8, maxItems: 12, items: { type: 'string' } },
      },
    },
  },
};
...
const KOMITE_LESSON_BLUEPRINT = [
  'KlinikIQ Komite Ders Anlatımı üretim sözleşmesi:',
