...
function buildPrompt({ branch, difficulty }) {
  return [
    ...
    'stem kullanıcıya görünecek tek soru metnidir: akıcı, doğal bir klinik paragraf gibi yaz; rapor parçalarını alt alta dizme. Muayene, laboratuvar ve görüntüleme bilgileri okunabilir kalsın ama vaka gerçek klinik hikaye gibi ilerlesin. Sonda yalnızca bir net soru cümlesi olsun.',
    'prompt aynı son soru cümlesini sadece metadata olarak taşısın; stem içinde sorulan anlamı farklı cümleyle ikinci kez tekrar etme.',
    'Soru hedefi tek ve net olsun: tanı soruyorsan seçenekler tanı, komplikasyon soruyorsan komplikasyon, mekanizma soruyorsan mekanizma, etken soruyorsan etken, tedavi soruyorsan tedavi olsun. Tanı, mekanizma, neden, sonuç ve komplikasyonu aynı seçenek setinde karıştırma.',
    'Soru cümlesinde “en olası neden/etiyoloji/komplikasyon/mekanizma” soruluyorsa seçenekler gerçekten neden/etiyoloji/komplikasyon/mekanizma olmalı; tanı seçeneklerini neden gibi sunma.',
    'Anatomi ve embriyoloji sorularında lokalizasyon ve köken bilgisi kusursuz tutarlı olsun: ark, kese ve yarık kavramlarını karıştırma; ark mezoderm/nöral krest katkılı iskelet-kas-damar-sinir ilişkileriyle, kese endodermal iç yapılarla, yarık ektodermal dış yapılarla düşünülmeli.',
    ...
    'Alt tip, kaynak, lokalizasyon veya etiyoloji ayrımı istiyorsan kökte bu ayrımı bilimsel olarak kilitleyen seçici testi, hormon paternini, görüntüleme fazını veya mikrobiyolojik bulguyu ver; bu veri yoksa soruyu daha geniş tanı düzeyinde kur.',
    'Mekanizma sorularında tartışmalı, dolaylı veya çok özel açıklamaları doğru cevap yapma; klasik, literatürde oturmuş ve TUS düzeyinde güvenle sorulabilecek mekanizmaları seç.',
    ...
    'Epidemiyolojik öykü, risk faktörü, görüntüleme veya laboratuvar sonucu tek başına cevabı kilitleyen ipucu olmasın; klinik paternle birlikte anlam kazansın.',
    ...
    'Köke doğru cevabı desteklemeyen, başka tanıyı gereksiz güçlendiren veya klinik bağlamı kirleten veri ekleme. Klinik bulgular, laboratuvar ve görüntüleme aynı tanısal eksene ve aynı anatomik lokalizasyona hizmet etsin.',
    'Lokalizasyon tutarlılığı zorunludur: hiler lezyon soruyorsan distal kanal bulgusu, karpal tünel soruyorsan proksimal median sinir bulgusu, belirli kas/sinir dalı soruyorsan başka seviyeyi düşündüren motor-duyu paterni verme.',
    'Laboratuvar, ultrasonografi, BT, MRG, patoloji ve mikrobiyoloji terimlerini kendi alanına uygun, doğal ve TUS diline yakın kullan; görüntüleme veya mikrobiyoloji ipucunu yanlış modalite/yanlış ifade ile verme.',
    'Mikrobiyoloji terminolojisinde yerleşik tıbbi ifadeleri kullan: “aside dirençli basil (ARB)” veya “asid-fast basil” denebilir; “asetik asit dirençli basil” gibi otomatik çeviri hissi veren yanlış terimler kullanma.',
    'Görüntüleme dili modaliteye özgü olsun: BT için dansite/kontrastlanma, MRG için T1-T2-FLAIR sinyal ve kontrast tutulumu, USG için ekojenite ve Doppler akımı gibi doğal terimleri kullan; modalite terimlerini karıştırma.',
    ...
    'Seçenekler karşılıklı dışlayıcı ve sınav seçeneği gibi doğal olmalı; gerçek klinik pratikte karşılığı olmayan, uydurma gibi duran, aşırı niş birleşik tanı, bozuk terminoloji, bariz alakasız kategori veya yapay seçenek kullanma.',
    ...
    'Her optionFeedback 2-3 net cümle olsun: doğruysa kökteki hangi veri kombinasyonuyla öne çıktığını, hangi karar noktasıyla ayrıldığını ve bu kararın arkasındaki mekanizmayı açıkla; yanlışsa o seçeneğin hangi durumda doğru olabileceğini, mevcut kökte hangi veriyle desteklenmediğini veya geride kaldığını, doğru seçenekten temel farkını ve öğrencinin tekrar kullanacağı bilgiyi söyle.',
    ...
    'TUS ipucu kategori etiketi değil, benzer soruda kullanılabilecek kısa çözüm anahtarı olmalı; hangi bulgu kombinasyonuna dikkat edileceğini söylesin.',
