...
function buildPrompt({ branch, difficulty }) {
  return [
    ...
    'Köke doğru cevabı desteklemeyen, başka tanıyı gereksiz güçlendiren veya klinik bağlamı kirleten veri ekleme. Klinik bulgular, laboratuvar ve görüntüleme aynı tanısal eksene hizmet etsin.',
