...
const iconPaths = {
  ...
  PatientProfile: <><circle cx="12" cy="8.2" r="2.7"/><path d="M6.7 18.4c.9-3.1 2.7-4.7 5.3-4.7s4.4 1.6 5.3 4.7"/><path d="M17.6 6.2h2.1M18.7 5.1v2.1"/></>,
  ClinicalPresentation: <><rect x="6.3" y="4.8" width="11.4" height="15.2" rx="2"/><path d="M9.5 4.8A2.5 2.5 0 0 1 12 3h0a2.5 2.5 0 0 1 2.5 1.8"/><path d="M9.2 10.2h5.6M9.2 13.2h5.6M9.2 16.2h3.8"/></>,
  PatientHistory: <><path d="M7.2 4.7h7.1l2.5 2.6v12H7.2z"/><path d="M14.3 4.7v2.8h2.5"/><path d="M9.7 11.1h4.6M9.7 14h4.6M9.7 16.9h2.9"/></>,
