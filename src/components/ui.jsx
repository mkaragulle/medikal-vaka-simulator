...
const iconPaths = {
  ...
  PatientProfile: <><rect x="4.5" y="5" width="15" height="14.5" rx="3"/><circle cx="10.4" cy="10.2" r="2.15"/><path d="M7.2 16.2c.65-2 1.75-3 3.2-3s2.55 1 3.2 3"/><path d="M14.8 9h2.1M14.8 12h2.1M14.8 15h1.5"/></>,
  ClinicalPresentation: <><rect x="5" y="4.4" width="14" height="16.2" rx="2.7"/><path d="M9 4.4A3 3 0 0 1 12 2h0a3 3 0 0 1 3 2.4"/><path d="M8.5 10h7M8.5 13.6h4.2"/><path d="M15.5 15.8h.01M15.5 12.4v1.8"/></>,
  PatientHistory: <><path d="M6.2 4.5h8.9l2.7 2.7v12.3H6.2z"/><path d="M15.1 4.5v3h3"/><path d="M9.1 10.5h5.8M9.1 13.7h5.8M9.1 16.9h3.6"/><path d="M6.2 7.7H4.7M6.2 12H4.7M6.2 16.3H4.7"/></>,
