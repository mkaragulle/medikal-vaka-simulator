...
const iconPaths = {
  ...
  PatientProfile: <><rect x="4.8" y="4.8" width="14.4" height="14.4" rx="3.2"/><circle cx="10.1" cy="10" r="2"/><path d="M7.6 15.9c.55-1.8 1.4-2.65 2.5-2.65s1.95.85 2.5 2.65"/><path d="M14.7 9.2h2M14.7 12h2M14.7 14.8h1.35"/></>,
  ClinicalPresentation: <><rect x="4.8" y="4.8" width="14.4" height="14.4" rx="3.2"/><path d="M8.4 8.7h7.2M8.4 12h5.8M8.4 15.3h4.2"/><path d="M16.2 14.4v1.6M16.2 17.5h.01"/></>,
  PatientHistory: <><rect x="4.8" y="4.8" width="14.4" height="14.4" rx="3.2"/><path d="M8.6 8.7h6.8M8.6 12h6.8M8.6 15.3h4.8"/><path d="M16.4 4.8v14.4"/></>,
