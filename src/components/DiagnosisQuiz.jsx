...
function FormattedQuestionPrompt({ text = '', glossaryEnabled = true, revealMode = 'preAnswer', maxTerms = 5 }) {
    ...
    >
      ...
      <span className={`answer-content ${isFlowOption ? 'has-flow' : ''}`.trim()}>
        {isFlowOption ? (
            ...
            {flowSegments.map((segment, segmentIndex) => (
              <span className="answer-flow-item" key={`${segmentIndex}-${segment}`}>
                <span className="answer-flow-segment" role="listitem">
                  <GlossaryText text={segment} enabled={glossaryEnabled} revealMode={revealMode} maxTerms={3} />
                </span>
          ...
          <span className="answer-title"><GlossaryText text={option} enabled={glossaryEnabled} revealMode={revealMode} maxTerms={3} /></span>
        )}
      </span>
