...
const EXPANDED_TUS_GLOSSARY_SEEDS = [
  ...
  },
  {
    ...
    "category": "Genetik",
    "previewDefinition": "Tek mutant alelin hastalık fenotipi oluşturabildiği kalıtım modelidir.",
    "preAnswerSafeDefinition": "Tek mutant alelin hastalık fenotipi oluşturabildiği kalıtım modelidir.",
    "shortDefinition": "Tek mutant alelin hastalık fenotipi oluşturabildiği kalıtım modelidir.",
    "detailedExplanation": "Tek mutant alelin hastalık fenotipi oluşturabildiği kalıtım modelidir. Klinik bağlamla birlikte yorumlanmalıdır.",
  ...
  },
  {
    ...
    "category": "Genetik",
    "previewDefinition": "Hastalık için iki mutant alelin gerektiği kalıtım modelidir.",
    "preAnswerSafeDefinition": "Hastalık için iki mutant alelin gerektiği kalıtım modelidir.",
    "shortDefinition": "Hastalık için iki mutant alelin gerektiği kalıtım modelidir.",
    "detailedExplanation": "Hastalık için iki mutant alelin gerektiği kalıtım modelidir. Klinik bağlamla birlikte yorumlanmalıdır.",
  ...
  },
  {
    ...
    "category": "Genetik",
    "previewDefinition": "Mutasyonun X kromozomunda olduğu ve erkeklerde daha sık fenotip verdiği kalıtım modelidir.",
    "preAnswerSafeDefinition": "Mutasyonun X kromozomunda olduğu ve erkeklerde daha sık fenotip verdiği kalıtım modelidir.",
    "shortDefinition": "Mutasyonun X kromozomunda olduğu ve erkeklerde daha sık fenotip verdiği kalıtım modelidir.",
    "detailedExplanation": "Mutasyonun X kromozomunda olduğu ve erkeklerde daha sık fenotip verdiği kalıtım modelidir. Klinik bağlamla birlikte yorumlanmalıdır.",
