...
export const AI_SYNTHETIC_FALLBACK_SEEDS = [
  seed({
    ...
    stem: 'Üç gündür burun akıntısı ve öksürüğü olan 8 aylık bebekte takipne, subkostal çekilme ve yaygın wheezing vardır. Ateş düşük derecelidir ve akciğer grafisinde fokal konsolidasyon saptanmaz.',
    exam: ['Yaygın ekspiratuvar wheezing', 'Subkostal çekilme', 'Dehidratasyon bulguları hafif'],
    vitals: { TA: '86/52 mmHg', Nabız: '138/dk', Solunum: '44/dk', SpO2: '%91', Ateş: '37.8 °C' },
    investigations: [{ id: 'synthetic-bronchiolitis-oximetry', label: 'Pulse oksimetre', type: 'monitoring', priority: 'essential', summary: 'Oksijen satürasyonu %91 ölçülür.', findings: ['Fokal konsolidasyon yok', 'Hipoksemi sınırda belirgin'] }],
    question: 'Bu bebek için en uygun ilk yaklaşım hangisidir?',
    options: [
      { id: 'A', text: 'Nazal aspirasyon, oksijen ve hidrasyon desteği' },
      { id: 'B', text: 'Rutin geniş spektrumlu antibiyotik başlamak' },
      { id: 'C', text: 'Her hastaya sistemik kortikosteroid vermek' },
      { id: 'D', text: 'Acil entübasyon ve mekanik ventilasyon' },
      { id: 'E', text: 'Antitüberküloz tedavi başlamak' },
    ],
    correctAnswer: 'A',
    explanation: 'Süt çocuğunda viral üst solunum yolu bulgularını izleyen wheezing ve çekilme bronşiolit lehinedir. İlk yaklaşım destek tedavisidir; hipoksemi varsa oksijen, beslenme azalmışsa hidrasyon ve sekresyon kontrolü öncelenir.',
    wrongOptionFeedback: {
    ...
    evidenceChain: ['Yaş bronşiolit için tipiktir.', 'Üst solunum yolu bulgularını wheezing izlemiştir.', 'Subkostal çekilme solunum eforunu gösterir.', 'Fokal konsolidasyon olmaması bakteriyel pnömoniyi zayıflatır.'],
  ...
  seed({
    ...
    exam: ['Nonpürülan konjonktivit', 'Çatlamış dudaklar', 'Servikal lenfadenopati'],
    vitals: { TA: '92/58 mmHg', Nabız: '124/dk', Solunum: '24/dk', SpO2: '%98', Ateş: '39.1 °C' },
    investigations: [{ id: 'synthetic-kawasaki-inflammatory', label: 'İnflamasyon belirteçleri', type: 'lab', priority: 'useful', summary: 'CRP 92 mg/L ve ESR 78 mm/saat ölçülür.', findings: ['Belirgin inflamatuvar yanıt', 'Trombosit sayısı izlemde artabilir'] }],
    question: 'Bu çocukta en uygun ilk tedavi yaklaşımı hangisidir?',
    options: [
      { id: 'A', text: 'Kawasaki hastalığı için IVIG ve aspirin başlamak' },
      { id: 'B', text: 'Kızamık için yalnız izolasyon ve A vitamini vermek' },
      { id: 'C', text: 'Streptokok tonsilliti için tek doz penisilin vermek' },
      { id: 'D', text: 'Anafilaksi için intramüsküler adrenalin uygulamak' },
      { id: 'E', text: 'Juvenil idiopatik artrit için metotreksat başlamak' },
    ],
    correctAnswer: 'A',
    ...
    evidenceChain: ['Ateş beş günden uzun sürmüştür.', 'Konjonktivit pürülan değildir.', 'Dudak ve döküntü bulguları mukokutanöz tutulumu gösterir.', 'Lenfadenopati Kawasaki kriterlerini destekler.'],
  ...
  seed({
    ...
    exam: ['Mukozalar kuru', 'Kussmaul solunumu', 'Karında yaygın hassasiyet'],
    vitals: { TA: '92/58 mmHg', Nabız: '122/dk', Solunum: '30/dk', SpO2: '%98', Ateş: '37.0 °C' },
    investigations: [{ id: 'synthetic-dka-gas', label: 'Kan gazı ve keton', type: 'lab', priority: 'essential', summary: 'pH 7.18, HCO3 9 mEq/L, glukoz 486 mg/dL, serum ketonu pozitif.', findings: ['Anyon açıklı metabolik asidoz', 'Ketozis ve hiperglisemi'] }],
    question: 'Bu hastada ilk tedavi basamağı hangisidir?',
    options: [
      { id: 'A', text: 'İzotonik salin ile sıvı resüsitasyonu' },
      { id: 'B', text: 'Bikarbonatı rutin ve erken vermek' },
      { id: 'C', text: 'Sadece subkutan hızlı etkili insülin vermek' },
      { id: 'D', text: 'Potasyum sonucunu önemsemeden yüksek doz insülin başlamak' },
      { id: 'E', text: 'Oral sıvı ve ayaktan izlem önermek' },
    ],
    correctAnswer: 'A',
    ...
    evidenceChain: ['Hiperglisemi belirgindir.', 'Keton pozitifliği vardır.', 'pH ve bikarbonat metabolik asidozu gösterir.', 'Dehidratasyon sıvı tedavisini öncelikli kılar.'],
  ...
  seed({
    ...
    exam: ['Sağ alt kadranda lokal hassasiyet', 'Rebound hafif pozitif', 'Murphy bulgusu yok'],
    vitals: { TA: '112/70 mmHg', Nabız: '102/dk', Solunum: '20/dk', SpO2: '%98', Ateş: '37.9 °C' },
    investigations: [{ id: 'synthetic-appendicitis-cbc', label: 'Tam kan sayımı ve CRP', type: 'lab', priority: 'useful', summary: 'Lökosit 14.800/mm³ ve CRP 48 mg/L ölçülür.', findings: ['Nötrofil baskın lökositoz', 'İnflamatuvar yanıt artmış'] }],
    question: 'Bu tablo en çok hangi tanıyı destekler?',
    options: [
      { id: 'A', text: 'Akut apandisit' },
      { id: 'B', text: 'Akut kolesistit' },
      { id: 'C', text: 'Pankreatit' },
      { id: 'D', text: 'Renal kolik' },
      { id: 'E', text: 'Gastroözofageal reflü' },
    ],
    correctAnswer: 'A',
    ...
    evidenceChain: ['Ağrı periumblikal başlayıp sağ alt kadrana göç etmiştir.', 'McBurney hassasiyeti vardır.', 'Lökositoz inflamasyonu destekler.', 'Murphy bulgusunun olmaması kolesistiti zayıflatır.'],
  ...
  seed({
    ...
    exam: ['Bilinç açık', 'Karında belirgin periton bulgusu yok', 'Vital bulgular stabil'],
    vitals: { TA: '118/76 mmHg', Nabız: '92/dk', Solunum: '18/dk', SpO2: '%99', Ateş: '36.8 °C' },
    investigations: [{ id: 'synthetic-apap-level', label: 'Parasetamol düzeyi', type: 'toxicology', priority: 'essential', summary: 'Serum parasetamol düzeyi tedavi çizgisinin üzerindedir.', findings: ['Alım zamanı belirlenmiştir', 'Hepatotoksisite riski vardır'] }],
    question: 'Bu hastada özgül antidot olarak hangi tedavi verilmelidir?',
    options: [
      { id: 'A', text: 'N-asetilsistein' },
      { id: 'B', text: 'Nalokson' },
      { id: 'C', text: 'Flumazenil' },
      { id: 'D', text: 'Atropin' },
      { id: 'E', text: 'Pralidoksim' },
    ],
    correctAnswer: 'A',
    ...
    evidenceChain: ['Yüksek doz parasetamol alımı vardır.', 'Alım zamanı tedavi kararında kullanılabilir.', 'Düzey tedavi çizgisinin üzerindedir.', 'Hepatotoksisite riski antidotu gerektirir.'],
  ...
  seed({
    ...
    exam: ['Skleral ikter', 'Karaciğer hafif hassas', 'Kronik karaciğer hastalığı stigmaları yok'],
    vitals: { TA: '116/74 mmHg', Nabız: '88/dk', Solunum: '16/dk', SpO2: '%98', Ateş: '37.6 °C' },
    investigations: [{ id: 'synthetic-hav-panel', label: 'Viral hepatit paneli', type: 'serology', priority: 'essential', summary: 'Anti-HAV IgM pozitif, Anti-HAV IgG negatif, HBsAg negatif, Anti-HBc IgM negatif, Anti-HCV negatif.', findings: ['HAV IgM saptanır', 'HBV akut belirteçleri negatif', 'HCV taraması negatif'] }],
    question: 'Bu serolojik patern en güçlü olarak hangi sonucu destekler?',
    options: [
      { id: 'A', text: 'Akut hepatit A enfeksiyonu' },
      { id: 'B', text: 'Geçirilmiş hepatit A bağışıklığı' },
      { id: 'C', text: 'Akut hepatit B enfeksiyonu' },
      { id: 'D', text: 'Kronik hepatit C enfeksiyonu' },
      { id: 'E', text: 'Hepatit B aşı bağışıklığı' },
    ],
    correctAnswer: 'A',
    ...
    evidenceChain: ['Akut sarılık ve koyu idrar vardır.', 'Anti-HAV IgM pozitif bulunmuştur.', 'HBV akut belirteçleri negatiftir.', 'Anti-HCV negatifliği HCV olasılığını azaltır.'],
  ...
  seed({
    ...
    exam: ['Yenidoğan genel durumu stabil', 'Dismorfik belirgin bulgu yok', 'Nörolojik muayene yaşına uygun'],
    vitals: { TA: '72/44 mmHg', Nabız: '138/dk', Solunum: '38/dk', SpO2: '%99', Ateş: '36.8 °C' },
    investigations: [{ id: 'synthetic-pku-aa', label: 'Plazma aminoasit analizi', type: 'lab', priority: 'essential', summary: 'Fenilalanin belirgin yüksek, tirozin düşük-normal aralıktadır.', findings: ['Fenilalanin artışı', 'Erken diyet tedavisi gerekir'] }],
    question: 'Bu metabolik tablo en çok hangi enzim kusuruyla ilişkilidir?',
    options: [
      { id: 'A', text: 'Fenilalanin hidroksilaz defekti' },
      { id: 'B', text: 'Branşlı zincir alfa-ketoasit dehidrogenaz defekti' },
      { id: 'C', text: 'Homogentizat oksidaz defekti' },
      { id: 'D', text: 'Galaktoz-1-fosfat üridiltransferaz defekti' },
      { id: 'E', text: 'Ornitin transkarbamilaz defekti' },
    ],
    correctAnswer: 'A',
    ...
    evidenceChain: ['Taramada fenilalanin yüksektir.', 'Tirozin göreceli düşük olabilir.', 'Tedavisiz nörogelişimsel hasar riski vardır.', 'Diyet tedavisi erken başlanmalıdır.'],
  ...
  seed({
    ...
    exam: ['Takipne olabilir', 'Oksijen satürasyonu düşebilir', 'Fokal havalanma kaybı şart değildir'],
    vitals: { TA: '118/76 mmHg', Nabız: '106/dk', Solunum: '26/dk', SpO2: '%92', Ateş: '36.7 °C' },
    investigations: [{ id: 'synthetic-vq-pattern', label: 'V/Q yorumu', type: 'physiology', priority: 'essential', summary: 'Ventilasyon korunurken perfüzyon azalması yüksek V/Q sonucunu oluşturur.', findings: ['Perfüzyon düşüktür', 'Ölü boşluk etkisi artar'] }],
    question: 'Bu durumda beklenen fizyolojik değişiklik hangisidir?',
    options: [
      { id: 'A', text: 'Yüksek V/Q ve alveoler ölü boşluk artışı' },
      { id: 'B', text: 'Düşük V/Q ve şant etkisi' },
      { id: 'C', text: 'Tam ventilasyon kaybı' },
      { id: 'D', text: 'Difüzyon kapasitesinde izole artış' },
      { id: 'E', text: 'Normal V/Q ile hiperkapni' },
    ],
    correctAnswer: 'A',
    ...
    evidenceChain: ['Ventilasyon korunmuştur.', 'Perfüzyon azalmıştır.', 'V/Q oranı yükselir.', 'Alveoler ölü boşluk etkisi artar.'],
  ...
  seed({
    ...
    exam: ['El bileği ekstansiyonu zayıf', 'Parmak ekstansiyonu zayıf', 'El sırtı radial bölgede duyu azalır'],
    vitals: { TA: '120/76 mmHg', Nabız: '92/dk', Solunum: '18/dk', SpO2: '%99', Ateş: '36.7 °C' },
    investigations: [{ id: 'synthetic-radial-xray', label: 'Humerus grafisi', type: 'imaging', priority: 'essential', summary: 'Humerus cisim kırığı izlenir.', findings: ['Spiral oluk komşuluğu etkilenebilir', 'Vasküler acil bulgu verilmemiştir'] }],
    question: 'Bu nörolojik bulgu en çok hangi sinirin hasarını düşündürür?',
    options: [
      { id: 'A', text: 'Radial sinir' },
      { id: 'B', text: 'Median sinir' },
      { id: 'C', text: 'Ulnar sinir' },
      { id: 'D', text: 'Aksiller sinir' },
      { id: 'E', text: 'Muskülokütan sinir' },
    ],
    correctAnswer: 'A',
    ...
    evidenceChain: ['Humerus cisim kırığı vardır.', 'El bileği ekstansiyonu kaybolmuştur.', 'Parmak ekstansiyonu zayıftır.', 'El sırtı radial duyusu etkilenmiştir.'],
  ...
  seed({
    ...
    exam: ['Orta hatta kistik kitle', 'Dil çıkarma ile hareket eder', 'Lateral servikal kitle yok'],
    vitals: { TA: '92/58 mmHg', Nabız: '96/dk', Solunum: '18/dk', SpO2: '%99', Ateş: '36.8 °C' },
    investigations: [{ id: 'synthetic-thyroglossal-location', label: 'Embriyolojik lokalizasyon', type: 'embryology', priority: 'essential', summary: 'Tiroid iniş yolu kalıntısını düşündüren orta hat yerleşim vardır.', findings: ['Orta hat yerleşim', 'Dil hareketiyle mobilite'] }],
    ...
    options: [
      ...
      { id: 'D', text: 'Servikal lenfadenit' },
      { id: 'E', text: 'Dermoid kist' },
    ],
    correctAnswer: 'A',
    ...
    evidenceChain: ['Kitle orta hattadır.', 'Dil çıkarma ile hareket eder.', 'Yutkunma sırasında mobilite vardır.', 'Lateral yerleşim olmaması brankial kisti zayıflatır.'],
  ...
  seed({
    ...
    exam: ['Periorbital ödem', 'Pretibial ödem', 'Hipertansiyon belirgin değil'],
    vitals: { TA: '94/60 mmHg', Nabız: '92/dk', Solunum: '18/dk', SpO2: '%99', Ateş: '36.7 °C' },
    investigations: [{ id: 'synthetic-mcd-urine', label: 'İdrar ve albümin', type: 'lab', priority: 'essential', summary: 'Proteinüri 4+, serum albümin 2.1 g/dL, hematüri belirgin değil.', findings: ['Masif proteinüri', 'Hipoalbüminemi', 'Hematüri baskın değil'] }],
    question: 'Bu patolojik tablo en çok hangi hastalığı düşündürür?',
    options: [
      { id: 'A', text: 'Minimal değişiklik hastalığı' },
      { id: 'B', text: 'Membranoproliferatif glomerülonefrit' },
      { id: 'C', text: 'Poststreptokokal glomerülonefrit' },
      { id: 'D', text: 'IgA nefropatisi' },
      { id: 'E', text: 'Goodpasture sendromu' },
    ],
    correctAnswer: 'A',
    ...
    evidenceChain: ['Hasta çocuk yaş grubundadır.', 'Masif proteinüri ve hipoalbüminemi vardır.', 'Hematüri baskın değildir.', 'Işık mikroskopisi normal görünebilir.'],
  ...
  seed({
    ...
    exam: ['Adneksiyal hassasiyet', 'Servikal hareket hassasiyeti hafif', 'Hemodinami stabil'],
    vitals: { TA: '108/68 mmHg', Nabız: '98/dk', Solunum: '18/dk', SpO2: '%99', Ateş: '36.8 °C' },
    investigations: [{ id: 'synthetic-ectopic-hcg', label: 'β-hCG ve ultrason', type: 'lab-imaging', priority: 'essential', summary: 'β-hCG 2600 mIU/mL, transvajinal ultrasonda intrauterin kese izlenmez.', findings: ['Adneksiyal hassasiyet vardır', 'İntrauterin gebelik gösterilememiştir'] }],
    question: 'Bu tablo için en olası tanı hangisidir?',
    options: [
      { id: 'A', text: 'Ektopik gebelik' },
      { id: 'B', text: 'Normal erken intrauterin gebelik' },
      { id: 'C', text: 'Molar gebelik' },
      { id: 'D', text: 'Pelvik inflamatuvar hastalık' },
    ...
    evidenceChain: ['Amenore sonrası pelvik ağrı vardır.', 'Vajinal lekelenme eşlik eder.', 'β-hCG pozitiftir.', 'Ultrasonda intrauterin kese izlenmez.'],
  ...
  seed({
    ...
    exam: ['Ense sertliği', 'Fotofobi', 'Fokal defisit belirgin değil'],
    vitals: { TA: '156/92 mmHg', Nabız: '104/dk', Solunum: '20/dk', SpO2: '%98', Ateş: '36.9 °C' },
    investigations: [{ id: 'synthetic-sah-redflag', label: 'Nörolojik kırmızı bayrak', type: 'clinical', priority: 'essential', summary: 'Thunderclap başlangıç ve meningeal bulgular vardır.', findings: ['Ani maksimum şiddet', 'Ense sertliği'] }],
    question: 'Bu hastada en uygun ilk tanısal yaklaşım hangisidir?',
    options: [
      { id: 'A', text: 'Kontrastsız beyin BT istemek' },
      { id: 'B', text: 'Migren tedavisi verip taburcu etmek' },
      { id: 'C', text: 'Elektif EEG planlamak' },
      { id: 'D', text: 'Sinüzit için antibiyotik başlamak' },
      { id: 'E', text: 'Gerilim tipi baş ağrısı olarak izlemek' },
    ],
    correctAnswer: 'A',
    ...
    evidenceChain: ['Ağrı saniyeler içinde maksimum şiddete ulaşmıştır.', 'Ense sertliği vardır.', 'Kusma eşlik eder.', 'Travma olmaması spontan kanamayı dışlamaz.'],
