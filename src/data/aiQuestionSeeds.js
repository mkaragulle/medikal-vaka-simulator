export const AI_QUESTION_SEEDS = [
    ...
    "investigations": [
      {
        ...
        "type": "lab",
        "priority": "useful",
        "summary": "AST: 910 U/L (referans <35 U/L; yüksek) U/L (Yüksek). ALT: 1180 U/L (referans <45 U/L; yüksek) U/L (Yüksek). ALP: 220 U/L (Yüksek).",
        "findings": [
          "AST: 910 U/L (referans <35 U/L; yüksek) U/L (referans <35 U/L) — Yüksek.",
          "ALT: 1180 U/L (referans <45 U/L; yüksek) U/L (referans <45 U/L) — Yüksek.",
          "ALP: 220 U/L (referans 40–130 U/L) — Yüksek.",
          "Total bilirubin: 5.1 mg/dL (referans 0.2–1.2 mg/dL) — Yüksek."
        ],
        "rows": [
          [
            "AST",
    ...
    "investigations": [
      {
        ...
        "type": "lab",
        "priority": "essential",
        "summary": "Sodyum: 128 mmol/L (referans 135–145 mmol/L; düşük) mmol/L (Düşük). Potasyum: 7.0 mEq/L (referans 3.5–5.1 mEq/L; yüksek) mmol/L mEq/L (Yüksek). Glukoz: 68 mg/dL (referans 70–100 mg/dL; düşük) mg/dL (Düşük).",
        "findings": [
          "Sodyum: 128 mmol/L (referans 135–145 mmol/L; düşük) mmol/L (referans 135–145 mmol/L) — Düşük.",
          "Potasyum: 7.0 mEq/L (referans 3.5–5.1 mEq/L; yüksek) mmol/L mEq/L (referans 3.5–5.1 mEq/L) — Yüksek. Potasyum bozukluğu aritmi riski açısından önemlidir.",
          "Glukoz: 68 mg/dL (referans 70–100 mg/dL; düşük) mg/dL (referans 70–100 mg/dL) — Düşük. Glukoz sapması metabolik bozukluğu destekler."
        ],
        "rows": [
          [
            "Sodyum",
      ...
      },
      {
        ...
        "type": "lab",
        "priority": "essential",
        "summary": "Potasyum: 7.0 mEq/L (referans 3.5–5.1 mEq/L; yüksek) mEq/L (Yüksek).",
        "findings": [
          "Potasyum: 7.0 mEq/L (referans 3.5–5.1 mEq/L; yüksek) mEq/L (referans 3.5–5.1 mEq/L) — Yüksek. Potasyum bozukluğu aritmi riski açısından önemlidir."
        ],
        "rows": [
          [
            "Potasyum",
  ...
  },
  {
    ...
    "examPearl": "Krup tedavisinde tüm şiddetlerde steroid verilir; istirahatte stridor varsa nebulize epinefrin eklenir."
  },
  {
    ...
    "investigations": [
      {
        ...
        "type": "lab",
        "priority": "essential",
        "summary": "Serum beta-hCG: 2400 mIU/mL (2400 mIU/mL).",
        "findings": [
          "Serum beta-hCG: 2400 mIU/mL (referans Negatif veya <5 mIU/mL) — 2400 mIU/mL."
        ],
        "rows": [
          [
            "Serum beta-hCG",
