...
export function normalizeEditorialText(text = '', { sectionTitle = '', fallback = '' } = {}) {
  let value = fixMedicalTypos(normalizeBasicEditorialText(text))
...
export function normalizeBasicEditorialText(text = '') {
