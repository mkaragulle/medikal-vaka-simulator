...
export const AI_BRANCH_RULES = [
  rule('pediatrics', ['Çocuk Sağlığı ve Hastalıkları', 'Pediatri', 'Çocuk'], {
    ...
    titles: ['Yüksek ateş ve peteşi', 'Süt çocuğunda hışıltılı solunum', 'Yenidoğanda sarılık paterni', 'İshal sonrası nöbet', 'Kusma ve dehidratasyon', 'Çocukta ense sertliği', 'Döküntü ve ateş', 'Adölesanda kilo kaybı'],
